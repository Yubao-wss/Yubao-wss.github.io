...
- BPMN实例：
  ...
  ![BPMN实例](F:\Github\Yubao-wss.github.io\public\image\BPMN实例.jpg)
...
![activiti类结构](F:\Github\Yubao-wss.github.io\public\image\activiti类结构.png)
...
- 在项目的resources目录下建立xxx.bpmn文件，并使用插件画出流程
  ...
  ![出差申请](F:\Github\Yubao-wss.github.io\public\image\出差申请.PNG)
